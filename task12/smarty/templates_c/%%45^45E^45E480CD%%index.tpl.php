<?php /* Smarty version 2.6.30, created on 2017-04-21 07:39:10
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'index.tpl', 8, false),array('function', 'html_options', 'index.tpl', 18, false),array('function', 'html_checkboxes', 'index.tpl', 32, false),array('modifier', 'default', 'index.tpl', 8, false),)), $this); ?>
...
">
    <div class="form-group"> <?php echo smarty_function_html_radios(array('name' => 'private','options' => $this->_tpl_vars['private_radios'],'selected' => ((is_array($_tmp=@$this->_tpl_vars['show_ads']->private)) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)),'separator' => ""), $this);?>
</div>
...
" name="price" id="fld_price">&nbsp;<span>руб.</span></label></p>
    ...
    <p><input type="submit"  class="btn btn-primary" value="<?php if (isset ( $_GET['id'] )): ?>Сохранить объявление<?php else: ?>
