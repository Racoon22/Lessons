...
<form action="index.php" method="POST">
    <input type="hidden" name="id" value="{$show_ads->id}">
    <div class="form-group"> {html_radios    name="private" options=$private_radios selected=$show_ads->private|default:0 separator=""}</div>
