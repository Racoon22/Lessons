<?php /* Smarty version 2.6.30, created on 2017-04-26 20:30:26
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'index.tpl', 11, false),array('function', 'html_options', 'index.tpl', 22, false),array('function', 'html_checkboxes', 'index.tpl', 36, false),array('modifier', 'default', 'index.tpl', 11, false),)), $this); ?>
...
">
    ...
    <p><label><b id="your-name">Ваше имя</b> 
            <input id ="seller_name" type="text" maxlength="40" class="form-input-text" value="<?php echo $this->_tpl_vars['show_ads']->seller_name; ?>
" name="seller_name" </input></label></p> 

    <p><label>Электронная почта
            <input  id ="email" type="text"  value="<?php echo $this->_tpl_vars['show_ads']->email; ?>
" name="email"></label></p>
    <p><label>Номер телефона
            <input id ="phone" type="text" value="<?php echo $this->_tpl_vars['show_ads']->phone; ?>
" name="phone"></label></p>
    ...
    <p><label>Название объявления
            <input id ="title" type="text" maxlength="50" class="form-input-text-long" value="<?php echo $this->_tpl_vars['show_ads']->title; ?>
" name="title"></label></p>
    <p><label for="fld_description" class="form-label" >Описание объявления 
            <textarea id="description" maxlength="6000" name="description" class="form-input-textarea"><?php echo $this->_tpl_vars['show_ads']->description; ?>
</textarea></label></p> 
...
" name="price" id="price">&nbsp;<span>руб.</span></label></p>
