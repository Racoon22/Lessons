<?php /* Smarty version 2.6.30, created on 2017-04-11 09:06:09
...
">
<?php echo smarty_function_html_radios(array('name' => 'private','options' => $this->_tpl_vars['private_radios'],'selected' => $this->_tpl_vars['private_id'],'separator' => ""), $this);?>

<p><label><b id="your-name">Ваше имя</b></label>
                <input type="text" maxlength="40" class="form-input-text" value="<?php echo $this->_tpl_vars['seller_name']; ?>
" name="seller_name" id="fld_seller_name"</input></p>  
<p><labe>Электронная почта</label>
                <input type="text"  value="<?php echo $this->_tpl_vars['email']; ?>
...
<p><label>Выбирете город</label>
   ...
   <?php echo smarty_function_html_options(array('name' => 'sity_id','options' => $this->_tpl_vars['city_options'],'selected' => $this->_tpl_vars['city_id']), $this);?>

</select>
<br>
<p><label>Выбирете категорию</label>

   <?php echo smarty_function_html_options(array('name' => 'category_id','options' => $this->_tpl_vars['category_options'],'selected' => $this->_tpl_vars['category_id']), $this);?>


<p><label>Название объявления</label> 
        <input type="text" maxlength="50" class="form-input-text-long" value="<?php echo $this->_tpl_vars['title']; ?>
" name="title" id="fld_title"></p>
    <p><label for="fld_description" class="form-label" id="js-description-label">Описание объявления</label> 
        <textarea maxlength="6000" name="description" id="fld_description" class="form-input-textarea"><?php echo $this->_tpl_vars['description']; ?>
</textarea></p> 
...
<?php echo smarty_function_html_checkboxes(array('name' => 'allow_mails','options' => $this->_tpl_vars['allow_mails_names'],'selected' => $this->_tpl_vars['allow_mails_id'],'separator' => "<br />"), $this);?>
